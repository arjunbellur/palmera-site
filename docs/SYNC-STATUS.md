...
| 17 | **Duplicate booking submissions.** Three identical `pending` bookings for Sunday Brunch, same slot, same guest, 1,000 XOF each (bk-49FF0ECA / bk-4F34A8AB / bk-C945A39A), created within ~30s. Looks like repeated checkout taps creating new docs. Consider idempotency on the app's create path. | **Samson** | flagged 2026-08-16 |

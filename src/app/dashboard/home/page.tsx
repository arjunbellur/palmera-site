...
export default function DashboardHome() {
  ...
  const addBtn: React.CSSProperties = { display: 'inline-flex', alignItems: 'center', gap: '0.5rem', padding: '0.625rem 1.25rem', background: 'var(--db-gold-deep)', border: 'none', borderRadius: '0.375rem', color: '#ebe8db', fontSize: '0.8125rem', fontFamily: 'var(--font-sans)', letterSpacing: '0.04em', cursor: 'pointer', textDecoration: 'none' }
            ...
            return (
              <a key={c.id} href={`/dashboard/companies/${c.id}`}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                  ...
                  {c.active && <span style={{ fontSize: '0.5625rem', color: 'var(--db-gold-deep)', border: '1px solid rgba(158,118,59,0.4)', padding: '0.125rem 0.4375rem', borderRadius: '2rem', fontFamily: 'var(--font-sans)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>{s.active}</span>}
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                  <div style={{ flex: 1, height: '4px', background: 'var(--db-border-subtle)', borderRadius: '2px', overflow: 'hidden' }}>
                    <div style={{ height: '100%', width: `${pct}%`, background: pct === 100 ? 'var(--db-gold-deep)' : 'var(--db-gold)', borderRadius: '2px' }} />
                  </div>

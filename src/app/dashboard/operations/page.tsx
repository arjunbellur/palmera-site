  ...
  return (
    <div>
      <div style={{ marginBottom: '2rem' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-display)', color: '#dfc9a6', fontSize: 'clamp(1.375rem, 3vw, 1.625rem)', fontWeight: 400, letterSpacing: '0.06em', margin: '0 0 0.375rem' }}>Booking Operations</h1>
        <p style={{ fontFamily: 'var(--font-serif)', color: 'rgba(223,201,166,0.72)', fontSize: '0.875rem', margin: 0 }}>How bookings flow once a guest reserves.</p>
      </div>
      <div style={{ background: 'rgba(158,118,59,0.06)', border: '1px solid rgba(158,118,59,0.15)', borderRadius: '0.5rem', padding: '1rem 1.25rem', marginBottom: '2rem' }}>
        <p style={{ fontSize: '0.8125rem', color: 'rgba(223,201,166,0.72)', fontFamily: 'var(--font-sans)', margin: 0, lineHeight: 1.6 }}>Standard Palmera ops: we send you bookings via WhatsApp, you confirm within 1 hour, we pay weekly via Wave. Please provide the contact of the person who actually runs day-to-day operations.</p>
      </div>
      <h2 style={{ fontFamily: 'var(--font-serif)', color: '#dfc9a6', fontSize: '1.0625rem', fontWeight: 400, margin: '0 0 1.25rem' }}>Booking contacts</h2>
      <div style={row}>
        <div><label style={lbl}>Ops contact name *</label><input style={inp} placeholder="Person who runs day-to-day ops" value={form.opsContactName} onChange={e => set('opsContactName', e.target.value)} /></div>
        <div><label style={lbl}>Ops contact WhatsApp *</label><input style={inp} placeholder="Direct WhatsApp number" value={form.opsContactWhatsapp} onChange={e => set('opsContactWhatsapp', e.target.value)} /></div>
      </div>
      <div style={row}>
      ...
      <h2 style={{ fontFamily: 'var(--font-serif)', color: '#dfc9a6', fontSize: '1.0625rem', fontWeight: 400, margin: '1.75rem 0 1.25rem' }}>Booking flow</h2>
      <div style={row}>
      ...
      <h2 style={{ fontFamily: 'var(--font-serif)', color: '#dfc9a6', fontSize: '1.0625rem', fontWeight: 400, margin: '1.75rem 0 1.25rem', display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
        Additional info <span style={{ fontSize: '0.625rem', color: 'rgba(223,201,166,0.65)', border: '1px solid rgba(223,201,166,0.25)', padding: '0.125rem 0.5rem', borderRadius: '0.1875rem', fontFamily: 'var(--font-sans)', letterSpacing: '0.06em', textTransform: 'uppercase' }}>First month</span>
      </h2>
      <div style={row}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', paddingTop: '1rem', borderTop: '1px solid rgba(223,201,166,0.08)', marginTop: '0.5rem' }}>

...
import { CalendarClock, TrendingUp, Wallet, Clock, Check } from 'lucide-react'
    ...
    <div className="pf-in">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 14rem), 1fr))', gap: '12px' }}>
        <div style={{ gridColumn: '1 / -1' }}>
          <EarningsHero bookings={earning} locale={locale} rate={rate} nextPayout={next ? toDate(next.scheduledFor) : null} available={balance}>

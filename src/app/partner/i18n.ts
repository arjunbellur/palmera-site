...
const FR: Record<string, string> = {
  ...
  dt_checkin: 'Arrivée → départ', dt_policy_terms: 'annulation gratuite jusqu’à {h} h avant', dt_view_payout: 'Voir dans Revenus',
...
const EN: Record<string, string> = {
  ...
  dt_checkin: 'Check-in → check-out', dt_policy_terms: 'free cancellation up to {h}h before', dt_view_payout: 'View in Earnings',

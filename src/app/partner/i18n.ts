...
const FR: Record<string, string> = {
  ...
  next_payout_amt: 'Votre prochain versement', next_payout_when: 'Expériences déjà réalisées, versées le {date}.',
...
const EN: Record<string, string> = {
  ...
  next_payout_amt: 'Your next payout', next_payout_when: 'Experiences already delivered, paid out on {date}.',
